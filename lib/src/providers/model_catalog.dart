...
class ModelCatalog {
  ...
  Future<List<String>> load({
    ...
    try {
      ...
      throw const ModelProviderException('获取模型超时，请检查网络后重试');
    } on SocketException {
      throw const ModelProviderException('无法连接服务，请检查网络和服务地址');
    } on HandshakeException {
      throw const ModelProviderException('安全连接失败，请检查服务地址和证书');
    } on FormatException {
      throw const ModelProviderException('该服务没有返回有效的模型列表');
    }
  }
