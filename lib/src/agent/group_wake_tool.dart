...
class GroupWakeTool implements AgentTool, RuntimeCapabilityAgentTool {
  ...
  ToolDefinition get definition => const ToolDefinition(
    ...
    description:
        '唤醒当前群聊中正在定时睡眠的另一位 AI 成员。群里会记录“操作者姓名唤醒了成员姓名”的系统事件，目标会带着最新消息重新思考。使用群成员列表中的 senderId，不要让用户填写。仅在需要对方参与或用户要求时调用，不要为了维持闲聊反复互相唤醒。不解除暂停自动接话，也不保证对方发言；已醒的成员不会重复触发。',
